...
//Blocking problem solved in GetResponseNB()
//To revert, remove all subsequent comments in this codeblock. and } immediately below return rp;
...
Response_Packet* FPS_GT511C3::GetResponseNB()
{
	byte firstbyte = 0;
	bool done = false;
	_serial.listen();
...
// sends the byte aray to the serial debugger in our hex format EX: "00 AF FF 10 00 13"
